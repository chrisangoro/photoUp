...
<?php
    session_start();
    include '/home/flondon1/public_html/scripts/login.php';
    include '/home/flondon1/public_html/scripts/registerlogic.php';
?>
...
<nav class="navbar navbar-default navbar-fixed-top" role="navigation">
  <div class="container-fluid">
    <div class="navbar-header">
      ...
      <a class="navbar-brand" href="#inicio">photo<small>Up</small></a>
    </div>

    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
      <ul class="nav navbar-nav">
        <li><a href="paginas\explore.php">Explore</a></li>
        <?php
            if (isset($_SESSION["CurrentUser"])){
                echo "<li><a href=\"paginas\gallery.php\">Gallery <span class=\"sr-only\">(current)</span></a></li>";
                echo "<li><a href=\"paginas\upload.php\">Upload <span class=\"sr-only\">(current)</span></a></li>";
            }
        ?>
...
<header>
    ...
    <div class="container">
        <div class="row">
            <div class="col-lg-12">
                <h1 class="page-header" align="center"><small>Welcome to </small>photoUp</h1>
                <div class="intro-text">
                    ...
                    <br>
                    <br>
                    <h3 align="center">photoUp is a great way to upload and share your memories <br> Upload and download your photos completely free!</h3>
                    <br>
                    <br>
                    <br>
                    <br>
